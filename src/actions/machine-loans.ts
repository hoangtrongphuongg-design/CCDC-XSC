 ...
 * lập đề nghị. Việc duyệt vẫn tách riêng cho Operator/Manager nhóm đang quản lý máy.
 */
...
/** Operator hoặc Manager của nhóm đang quản lý máy được duyệt. */
...
/** Operator/Manager nhóm cho xác nhận đã giao máy. */

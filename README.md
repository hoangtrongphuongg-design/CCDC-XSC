...
## V1.5.8 - Bảng Người dùng không cuộn ngang
- Bảng **Danh sách tài khoản** dùng layout cố định theo khung nội dung trên desktop.
- Chia lại tỷ lệ 7 cột để cột Quyền nhóm có đủ không gian.
- Nội dung dài được phép xuống dòng; bỏ nguyên nhân `min-width` gây tràn ngang trong bảng người dùng.
- Nút **Quản lý** giữ trên một hàng.
- Mobile vẫn dùng giao diện card/responsive sẵn có.
- Không thay database/schema/migration.
